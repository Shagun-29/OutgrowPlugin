...
wp_register_style('my-plugin-style2', plugins_url('/outgrow/css/line-awesome/css/line-awesome-font-awesome.css'));
wp_register_style('my-plugin-style3', plugins_url('/outgrow/css/line-awesome/css/line-awesome.css'));
...
function wdm_add_tinymce_plugin( $plugin_array ) {
  $plugin_array['wdm_mce_dropbutton'] =  plugins_url('/outgrow/tinymce-custom-class.js');
  return $plugin_array;
}
