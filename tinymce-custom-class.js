...
function selectAPI(){
  console.log("------selectAPI------",document.getElementById("loader-section"));
  document.getElementById("loader-section").innerHTML="<div id='loader-div-class-editor'>"
  +"<img class='loader-image-editor' src='https://d1httwb3aso1fd.cloudfront.net/logoAnim.gif' alt=''></div>";
  // var data="";
